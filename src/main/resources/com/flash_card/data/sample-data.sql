...
INSERT INTO flashcard_sets (set_id, set_name, set_description, set_topic, creator_id) VALUES
                                                                                          (1, 'Biology Basics', 'Introduction to biology concepts', 'Biology', 1),
                                                                                          (2, 'Physics 101', 'Fundamental physics principles', 'Physics', 2),
                                                                                          (3, 'Advanced Physics', 'Advanced topics in physics', 'Physics', 3),
                                                                                          (4, 'Chemistry Basics', 'Introduction to chemistry concepts', 'Chemistry', 4);

-- Insert Flashcards
INSERT INTO flashcards (card_id, term, definition, difficult_level, set_id, creator_id) VALUES
                                                                                            (1, 'Photosynthesis', 'Process by which plants make food', 'easy', 1, 1),
                                                                                            (2, 'Mitochondria', 'Powerhouse of the cell', 'hard', 1, 1),
                                                                                            (3, 'Newton\'s Laws', 'Laws of motion and gravity', 'easy', 2, 2),
(4, 'Quantum Physics', 'Study of atomic and subatomic particles', 'hard', 3, 3);

-- Insert Classrooms
INSERT INTO classrooms (classroom_id, classroom_name, description, teacher_id) VALUES
(1, 'Biology Class', 'Introductory biology for beginners', 1),
(2, 'Physics Class', 'Fundamentals of physics', 2),
(3, 'Chemistry Class', 'Basic chemistry concepts', 4);

-- Insert Studies
INSERT INTO studies (study_id, user_id, set_id, start_time, end_time, number_studied_words) VALUES
(1, 1, 1, '2023-10-01 08:00:00', '2023-10-01 09:00:00', 15),
(2, 2, 2, '2023-10-02 14:00:00', '2023-10-02 15:00:00', 20),
(3, 3, 3, '2023-10-03 16:00:00', '2023-10-03 17:00:00', 10);

-- Insert Quizzes
INSERT INTO quizzes (quiz_id, user_id, set_id, start_time, end_time, correct_times, wrong_times) VALUES
(1, 1, 1, '2023-10-01 10:00:00', '2023-10-01 10:30:00', 8, 2),
(2, 2, 2, '2023-10-02 11:00:00', '2023-10-02 11:45:00', 5, 5),
(3, 3, 3, '2023-10-03 09:00:00', '2023-10-03 09:20:00', 10, 0);
